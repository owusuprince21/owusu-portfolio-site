...
const CurvedInput = ({
  ...
  if (geom && layout) {
    ...
    content = (
      <svg
        ref={svgRef}
        className="block h-auto w-full cursor-text select-none overflow-visible [-webkit-tap-highlight-color:transparent] [&_text]:font-[inherit]"
        width={geom.W}
      ...
      >
        ...
        {showButton && (
          ...
          >
            <path
              className="transition-[filter,opacity] duration-200 ease-in-out group-hover:brightness-[1.12] group-focus-visible:brightness-[1.18] group-active:brightness-[0.94]"
              d={buttonPath}
              fill={accentColor}
            />
