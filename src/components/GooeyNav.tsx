    ...
    <>
      ...
      <div className="relative gooey-nav" ref={containerRef}>
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className="flex gap-4 lg:gap-6 list-none p-0 px-2 m-0 relative z-[3]"
            style={{
              color: 'white',
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.55em] px-[0.85em] lg:px-[1em] inline-block text-sm lg:text-base whitespace-nowrap"
                >
                  {item.label}
                </a>
              </li>
